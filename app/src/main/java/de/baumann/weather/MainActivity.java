...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_license) {
            Intent intent_in = new Intent(de.baumann.weather.MainActivity.this, de.baumann.weather.Info.class);
    ...
    public void fab2_click(View v) {
        // write your code here ..
        mWebView.loadUrl("http://m.wetterdienst.de/Wetter/Stutensee/stuendlich/");
        setTitle(R.string.ort1_stuendlich);
        if (!isNetworkAvailable()) { // loading offline
            mWebView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            Snackbar.make(mWebView, R.string.toast_cache, Snackbar.LENGTH_LONG).show();
        }
    ...
    public void fab3_click(View v) {
        // write your code here ..
        mWebView.loadUrl("http://m.wetterdienst.de/Wetter/Stutensee/10-Tage/");
        setTitle(R.string.ort1_trend);
        if (!isNetworkAvailable()) { // loading offline
            mWebView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            Snackbar.make(mWebView, R.string.toast_cache, Snackbar.LENGTH_LONG).show();
        }
    ...
    public void fab4_click(View v) {
        ...
        setTitle(R.string.ort1_bericht);
        if (!isNetworkAvailable()) { // loading offline
            mWebView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            Snackbar.make(mWebView, R.string.toast_cache, Snackbar.LENGTH_LONG).show();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.ort1) {
            Intent intent_in = new Intent(MainActivity.this, MainActivity.class);
            startActivity(intent_in);
            ...
            Intent intent_in = new Intent(MainActivity.this, Bookmarks.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.action_radar) {
            Intent intent_ra = new Intent(MainActivity.this, InfoMeteo.class);
            ...
            Intent intent_th = new Intent(MainActivity.this, InfoDWD.class);
            ...
            Intent intent_le = new Intent(MainActivity.this, InfoDWD.class);
