...
public class MainActivity3 extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.ort3_ueberblick);
        ...
        mWebView.loadUrl("http://m.wetterdienst.de/Wetter/Berlin/");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_license) {
            Intent intent_in = new Intent(MainActivity3.this, Info.class);
    ...
    public void fab2_click(View v) {
        // write your code here ..
        mWebView.loadUrl("http://m.wetterdienst.de/Wetter/Berlin/stuendlich/");
        setTitle(R.string.ort3_stuendlich);
        if (!isNetworkAvailable()) { // loading offline
            mWebView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            Snackbar.make(mWebView, R.string.toast_cache, Snackbar.LENGTH_LONG).show();
        }
    ...
    public void fab3_click(View v) {
        // write your code here ..
        mWebView.loadUrl("http://m.wetterdienst.de/Wetter/Berlin/10-Tage/");
        setTitle(R.string.ort3_trend);
        if (!isNetworkAvailable()) { // loading offline
            mWebView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            Snackbar.make(mWebView, R.string.toast_cache, Snackbar.LENGTH_LONG).show();
        }
    ...
    public void fab4_click(View v) {
        // write your code here ..
        mWebView.loadUrl("http://m.wetterdienst.de/Vorhersage/Berlin/");
        setTitle(R.string.ort3_bericht);
        if (!isNetworkAvailable()) { // loading offline
            mWebView.getSettings().setCacheMode(WebSettings.LOAD_CACHE_ELSE_NETWORK);
            Snackbar.make(mWebView, R.string.toast_cache, Snackbar.LENGTH_LONG).show();
        }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.ort1) {
            Intent intent_in = new Intent(MainActivity3.this, MainActivity.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort2) {
            Intent intent_in = new Intent(MainActivity3.this, MainActivity2.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort3) {
            Intent intent_in = new Intent(MainActivity3.this, MainActivity3.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort4) {
            Intent intent_in = new Intent(MainActivity3.this, MainActivity4.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort5) {
            Intent intent_in = new Intent(MainActivity3.this, MainActivity5.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.bookmarks) {
            Intent intent_in = new Intent(MainActivity3.this, Bookmarks.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.action_radar) {
            Intent intent_ra = new Intent(MainActivity3.this, InfoMeteo.class);
            ...
            Intent intent_th = new Intent(MainActivity3.this, InfoDWD.class);
            ...
            Intent intent_le = new Intent(MainActivity3.this, InfoDWD.class);
