...
public class Info extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_license) {
            Intent intent_in = new Intent(Info.this, Info.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.ort1) {
            Intent intent_in = new Intent(Info.this, MainActivity.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort2) {
            Intent intent_in = new Intent(Info.this, MainActivity2.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort3) {
            Intent intent_in = new Intent(Info.this, MainActivity3.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.ort4) {
            Intent intent_in = new Intent(Info.this, MainActivity4.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.bookmarks) {
            Intent intent_in = new Intent(Info.this, Bookmarks.class);
            startActivity(intent_in);
            overridePendingTransition(0, 0);

        } else if (id == R.id.action_radar) {
            Intent intent_ra = new Intent(Info.this, InfoMeteo.class);
            ...
            Intent intent_th = new Intent(Info.this, InfoDWD.class);
            ...
            Intent intent_le = new Intent(Info.this, InfoDWD.class);
